...
class ToMeCLIPAttention(CLIPAttention):
    ...
    def forward(
        ...
        k = key_states.reshape([bsz, self.num_heads, -1, self.head_dim]).mean(1)
        ...
        return attn_output, attn_weights_reshaped, k


def make_tome_class(transformer_class):
    class ToMeCLIPVisionTransformer(transformer_class):
        """
        Modifications:
...
def apply_patch(
    model: CLIPVisionTransformer, trace_source: bool = False, prop_attn: bool = True, r=8
):
    """
    ...
    """
    ToMeCLIPVisionTransformer = make_tome_class(model.__class__)

    model.__class__ = ToMeCLIPVisionTransformer
    model.r = r
    model._tome_info = {
        "r": model.r,
        "size": None,
